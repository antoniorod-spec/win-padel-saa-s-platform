      ...
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid gap-8 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            {/* Redes sociales - actualiza los href con tus URLs reales */}
            <div className="mt-4 flex gap-3">
              <a
                href="https://instagram.com/whinpadel"
                target="_blank"
              ...
              <a
                href="https://facebook.com/whinpadel"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-muted text-muted-foreground transition-colors hover:bg-primary hover:text-primary-foreground"
                aria-label="Facebook"
              ...
              <a
                href="https://tiktok.com/@whinpadel"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-muted text-muted-foreground transition-colors hover:bg-primary hover:text-primary-foreground"
                aria-label="TikTok"
